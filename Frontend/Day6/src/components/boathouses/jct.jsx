...
const Jct=()=> {
  ...
  const handleBooking = async (event) => {
    ...
    try {
      const response = await axios.post("http://localhost:8080/api/booking/add", {
        fullName:fullName,
        email: email,
        phone:phone,
        startDate:startDate,
...
<p>JCT Houseboats is 5.8 km from Alleppey Railway Station. Mararikulam Fishing Village is 17.5 km away while Kochi Airport is 61 km from the houseboat.</p>
    <p>Providing unique accommodation on water, JCT Houseboats is a wooden boat offering overwater rooms. It has a common kitchen and sun deck. A restaurant is available.</p>  
      ...
      <img data-aos="zoom-in" data-aos-delay="100" data-aos-duration="1000" className='img1' src="https://res.cloudinary.com/dcc7xkmex/image/upload/v1709313088/7_nuffui.jpg" alt="r1" />
      <img data-aos="zoom-in" data-aos-delay="100" data-aos-duration="1000" className="img2" src="https://res.cloudinary.com/dcc7xkmex/image/upload/v1709313085/8_pkm6cx.jpg" alt="r2" />
      <div className='room'>
      <h2>Room Service</h2>
